...
Partial Public Class DataSet1
    ...
    Partial Public Class Table1DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddTable1Row(ByVal ACCESSLEVEL As String, ByVal USERNAME As String, ByVal PASSWORD As String) As Table1Row
            Dim rowTable1Row As Table1Row = CType(Me.NewRow,Table1Row)
            Dim columnValuesArray() As Object = New Object() {Nothing, ACCESSLEVEL, USERNAME, PASSWORD}
    ...
    Partial Public Class Table1Row
        ...
        Public Property ACCESSLEVEL() As String
            Get
                Try 
                    Return CType(Me(Me.tableTable1.ACCESSLEVELColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'ACCESSLEVEL' in table 'Table1' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableTable1.ACCESSLEVELColumn) = value
            End Set
        End Property
        ...
        Public Function IsACCESSLEVELNull() As Boolean
            Return Me.IsNull(Me.tableTable1.ACCESSLEVELColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub SetACCESSLEVELNull()
            Me(Me.tableTable1.ACCESSLEVELColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace DataSet1TableAdapters
    ...
    Partial Public Class Table1TableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Table1` WHERE ((`ID` = ?) AND ((? = 1 AND `ACCESSLEVEL` IS NULL) OR "& _ 
                "(`ACCESSLEVEL` = ?)) AND ((? = 1 AND `USERNAME` IS NULL) OR (`USERNAME` = ?)) AN"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Table1` (`ACCESSLEVEL`, `USERNAME`, `PASSWORD`) VALUES (?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Table1` SET `ACCESSLEVEL` = ?, `USERNAME` = ?, `PASSWORD` = ? WHERE ((`ID"& _ 
                "` = ?) AND ((? = 1 AND `ACCESSLEVEL` IS NULL) OR (`ACCESSLEVEL` = ?)) AND ((? = "& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Gui_Tset.My.MySettings.Default.userlogin11ConnectionString1
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        Table1.*"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Table1"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_ACCESSLEVEL As String, ByVal Original_USERNAME As String, ByVal Original_PASSWORD As String) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(2).Value = CType(Original_ACCESSLEVEL,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal ACCESSLEVEL As String, ByVal USERNAME As String, ByVal PASSWORD As String) As Integer
            If (ACCESSLEVEL Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(0).Value = CType(ACCESSLEVEL,String)
            End If
        ...
        Public Overloads Overridable Function Update(ByVal ACCESSLEVEL As String, ByVal USERNAME As String, ByVal PASSWORD As String, ByVal Original_ID As Integer, ByVal Original_ACCESSLEVEL As String, ByVal Original_USERNAME As String, ByVal Original_PASSWORD As String) As Integer
            If (ACCESSLEVEL Is Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(0).Value = CType(ACCESSLEVEL,String)
            End If
            If (USERNAME Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(Original_ACCESSLEVEL,String)
            End If
            If (Original_USERNAME Is Nothing) Then
